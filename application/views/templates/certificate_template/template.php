...
<head>
    ...
    <title>My CPD Unit</title>
        ...
        <?php 
        $img9 = BASE_URL."assets/templates/template3/certificate.jpg";
        ?>
    ...
    <style>
        .certificate {
            ...
            padding: 1em;
            background: url(http://localhost/ci/assets/templates/template3/certificate.jpg) no-repeat center center;
            height: 800px;
            position: relative;
    ...
    <div class="certificate">
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <div class="unit">CPD Unit 4</div>
                       <?php 
                         $img2 = BASE_URL."assets/templates/template3/signature.png";
                        ?>
        ...
        <div class="foot">
            ...
            <div class="barcode" style="margin-top: 40px;">
                    <?php 
                    $img4 = BASE_URL."assets/templates/template3/barcode.png";
                    ?> 
