...
<body>
    ...
    <?php
        ...
        ?>
     <table border="0" align="center" width="100%" style=" background-image: url(<?php echo showimage($img3); ?>); background-repeat: no-repeat; background-position: 0 center 0;">
		 <tr>
            <th style=" width:100%;" >
                <table style=" width: 70%; margin: 0 auto; text-align:  center;font-family: 'Montserrat', sans-serif; margin-top: 25px;">
                    <tr style="">
                        <th style=" width: 20%;    text-align: center; ">
                            <span class="images" style=" display: inline-block;vertical-align: middle; float: left;margin-top: 5px;"><img src="<?php echo showimage($logo1); ?>" alt="" style="width: 75px;"></span>
                        </th>
                        <th style="text-align: center;width: 80%;">
  
                            <span class="hesder-content" style=" display: inline-block; color: #0d0d0d; font-weight: 600;  font-size: 18px; line-height: 21px; text-align: center;">
                       ...
                       <th style="width: 20%; text-align: center;">
                            <?php if($certificate['logo2']!=''){ ?>
                                <span class="images" style=" display: inline-block; vertical-align:middle; float: right;margin-top: 5px; "><img src="<?php echo showimage($logo2); ?>" alt="" style="width: 75px;">
                                </span>
                            <?php }?>
                        </th>
                    </tr>
        ...
        <tr>
            <td>
                <table style="width: 300px; margin: 0 auto;margin-top: 5px; text-align: center;">
        ...
        <tr>
            <td style="text-align: center;"> 
                ...
                <p
                    style=" font-size: 13px;color: #0d0d0d; margin-top: 5px; font-weight: 500; font-family: 'Montserrat', sans-serif;"><?php echo $certificate['intro_text']; ?></p>
                <p
                ...
                <p style=" margin-top: 0px; font-size: 13px; font-family: 'Montserrat', sans-serif;"><?php echo date('F d, Y',strtotime($cust_data['added_on'])); ?></p>
                <!-- <?php // if(!empty($owner['address'])){ ?>
                <p style=" color: #2e85c1;  font-size: 15px;  margin-top: 0px; font-family: 'Montserrat', sans-serif; font-weight: 600;  margin-bottom:0;"><?php // echo $owner['address']; ?>,</p><?php // }else{echo'<br><br><br>';}?> -->
                <p style=" color: #2e85c1; font-size: 15px;font-family: 'Montserrat', sans-serif; font-weight: 600; margin-top: 0px;"><?php echo $certificate['location']; ?></p>
        ...
        <tr>
           <td>
               <table width="80%" style="margin: 0px auto;padding: 0 20px;">
                    <tr>
