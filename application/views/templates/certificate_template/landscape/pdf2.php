...
<body>
    <?php
     ...
     <table border="0" align="center" width="100%"  style=" background-image: url(<?php echo showimage($img3); ?>); background-position:0 center 0;     background-repeat: no-repeat; ">
		 <tr>
            <th style=" width:100%;" >
                <table style=" width: 70%; margin: 0 auto; text-align:  center;font-family: 'Montserrat', sans-serif; margin-top: 50px;">
                    <tr style="">
                        <th style=" width: 15%;    text-align: center; ">
                            <span class="images" style=" display: inline-block;     vertical-align: middle; float: left;"><img src="<?php echo showimage($logo1); ?>" alt="" style="width: 50px;"></span>
                        </th>
                        <th style="text-align: center;width: 70%;">
  
                            <span class="hesder-content" style=" display: inline-block; color: #0d0d0d; font-weight: 600;  font-size: 16px; line-height: 17px; text-align: center;">
                       ...
                       <th style="width: 15%; text-align: center;">
                            <?php if($certificate['logo2']!=''){ ?>
                                <span class="images" style=" display: inline-block; vertical-align: middle; float: right; "><img src="<?php echo showimage($logo2); ?>" alt="" style="width: 50px;">
                                </span>
                            <?php }?>
                        </th>
                    </tr>
        ...
        <tr>
            <td>
                <table style="width: 300px; margin: 0 auto;margin-top: 12px; text-align: center;">
                    ...
                    <tr>
                        <td><img src="<?php echo showimage($text_certificate); ?>" style=" width:240px; "></td>
        ...
        <tr>
            <td>
                <h1
                    style=" color: #dd8827; text-transform: uppercase; font-family: 'Montserrat', sans-serif; font-weight: 600; text-align: center;    margin:0; font-size:16px;">
                    <?php echo $certificate['title']; ?></h1>
            </td>
        </tr>
        <tr style="text-align: center;">
            <td>
                <h1 style="font-family: 'Tangerine'; font-size: 20px;font-weight: 700; margin: 0px 0 0px 0; "><?php echo ucwords($certificate['user_name']); ?></h1>
                <span
                    style="border-top: 1px dotted #d2d2d2;width: 60%;height: 1px;display: block;margin: 0 auto;margin-top: 10px;"></span>

                <p
                    style=" font-size: 13px;color: #0d0d0d; margin-top: 5px; margin-bottom:0;  font-weight: 500; font-family: 'Montserrat', sans-serif;"><?php echo $certificate['intro_text']; ?></p>
                <p
                    style="font-size: 15px;color: #2e85c1; margin-top: 0px; font-family: 'Montserrat', sans-serif; font-weight: 600;  margin-bottom:0;"><?php echo $certificate['training_title']; ?></p>

                <p style=" margin-top: 0px; margin-bottom:0; font-size: 13px; font-family: 'Montserrat', sans-serif;"><?php echo date('F d, Y',strtotime($cust_data['added_on'])); ?></p>
               

                <p style="margin-bottom:0; color: #2e85c1; font-size: 15px;font-family: 'Montserrat', sans-serif; font-weight: 600; margin-top: 0px;"><?php echo $certificate['location'];?>
            </p>

                <p style=" margin-top: 0px; font-size: 15px; font-weight: 600; font-family: 'Montserrat', sans-serif; margin-bottom:0;">
                ...
                <table style="margin: 0 auto; margin-top: 0px;">
                    <tr>
                        ...
                        <td
                            ...
                            <img src="<?php echo showimage($sugnature[$i]); ?>" alt="signature" style=" width: 30px;">
                             <strong>
							 <p style="margin: 0; margin-top: 2px; color: #7c7c7c; font-size: 13px;"><?php echo ucwords($namearray[$i]) ?></p></strong>
                            <p style=" margin: 0; margin-top: 2px;color: #7c7c7c;font-size: 13px;"><?php echo ucwords($postionarray[$i]); ?></p>
        ...
        <tr>
            <td>
                <table style="
                width: 80%; margin: 0 auto; padding-top: 110px; padding-bottom: 0px; ">
                    <tr> 
                        <td style="text-align: left;width: 60%;"> 
                            <img src="<?php echo showimage($ceonpointlogo); ?>" style="width: 180px;">
                            <?php if(1){ ?>
                            <p
                        ...
                        <img src="<?php echo showimage($barcode); ?>" style="width: 40px;">
                            <p
                        ...
                        <!-- <td style="text-align: left;width: 60%;">
                            ...
                            <p
                                style=" color: #f2cd1e; font-size: 14px; margin: 5px 0; font-family: 'Montserrat', sans-serif; ">
                                validate this certificate at:</p>
                            <a href="#"
