...
<?php $barcode = ASSETS_URL.'images/uploads/'.$cust_data[0]['barcode']; ?>
    ...
    <tr>
     ...
     <tr>
      ...
      <tr>
        <td align="center">
                <p style="font-family: 'Tangerine';font-size: 48px;font-weight: 700;margin: 17px 0 0 0;line-height: 19px;"><?php echo ucwords($profile[0]['name']); ?></p>
               <span style="border-top: 1px dotted #d2d2d2;width: 70%;height: 0px;display: block;margin: 0 auto;margin-top: 13px;"></span>
                ...
                <p
                    style="width:95%; font-size: 1vw;color: #2e85c1; margin-top: 13px; font-family: 'Montserrat', sans-serif; font-weight: 600;"><?php echo ucwords($certificate[0]['training_title']); ?></p>
                <?php if($certificate[0]['training_sub_title']!=''){?>
                <p
                    style="width:95%; font-size: 0.69vw;color: #2e85c1; margin-top: 13px; font-family: 'Montserrat', sans-serif; font-weight: 600;"><?php echo $certificate[0]['training_sub_title']; ?></p>
                <?php } ?>
                <p
                ...
                <p style="margin-top: 0;font-size: 15px;font-weight: 600;font-family: 'Montserrat', sans-serif;">
                    Contact Hours: <?php echo $certificate[0]['units']; ?></p>
     ...
     <tr>
        <td align="center">
           <table style="margin: 0 auto;margin-top: 0;margin-bottom: 64px;">
                    <tr>
                        <?php 
                          if($num == 1){
                            $width = '100%';
                        ...
                        <td
                            ...
                            <?php if($signautreimg[$i]!=''){ ?><img src="<?php echo showimage($signautreimg[$i]); ?>" style=" width: 60px;"><?php } ?>
               ...
               <table width="100%" style="">
                    <tr>
                        <td style="text-align: left; padding: 0 0 10px 10px;">
                            ...
                            <p
                                style="color: #fff; font-size: 14px; margin: 6px 0; font-family: 'Montserrat', sans-serif; line-height: 1em;">
                            ...
                            <p
                                style=" color: #fff; font-size: 13px; margin: 15px 0 6px; font-family: 'Montserrat', sans-serif; line-height: 1em;">
                        ...
                        <td style="text-align: right;  padding: 0 10px 10px 0px;">
                            ...
                            <p
                                style="color: #fff; font-size: 14px; margin: 6px 0; font-family: 'Montserrat', sans-serif; line-height: 1em;">Accreditation Number</p>
                            <p
                                ...
                                <p
                                style=" color: #fff; font-size: 13px; margin: 15px 0 6px; font-family: 'Montserrat', sans-serif; line-height: 1em;">validate this accreditation no. at:</p>
                            <a href="#"
