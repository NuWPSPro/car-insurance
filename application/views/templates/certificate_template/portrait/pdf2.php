                ...
                <table  width="100%" style="width: 100%;margin: 0 auto;padding: 0 10px 0 52px;margin-top: 35px;margin-bottom: 50px;">
                    <tr>
                       <td style="text-align: right;  padding-right: 32px;">
                        ...
                        <p style="color: #000; font-size: 13px; margin: 6px  0; font-family: 'Montserrat', sans-serif;line-height: 1em;"> Certificate Number & Validtion Link</p>
                        ...
                        <!-- <p style="color: #000; font-size: 13px; margin: 0; font-family: 'Montserrat', sans-serif;">validate this certificate at:</p> -->
                        <p style="color: #000; font-size: 13px; margin: 0; font-family: 'Montserrat', sans-serif;">https://ceonpoint.com/index.php/pages/cfvalidation</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right;padding: 20px 31px 0 0;">
                            <?php if($has_acc == true){ ?>
