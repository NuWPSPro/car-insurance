...
<head>
    ...
    <title>My CPD Unit</title>
        ...
        <?php 
        $img9 = BASE_URL."assets/templates/template2/certificate.jpg";
        ?>
    ...
    <style>
        .certificate {
            ...
            padding: 1em;
            background: url(http://localhost/ci/assets/templates/template2/certificate.jpg) no-repeat center center;
            height: 800px;
            position: relative;
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="2" align="right" class="header">
                    <span>
                        <?php 
                         $img = BASE_URL."assets/templates/template2/owner.png";
                        ?>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="cpd-profile">
                     <?php 
                         $img1 = BASE_URL."assets/templates/template2/profile.jpg";
                        ?>
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <div class="unit">CPD Unit 4</div>
                       <?php 
                         $img2 = BASE_URL."assets/templates/template2/signature.png";
                        ?>
        ...
        <div class="foot">
            <div class="time">
                ...
                <span style="display: block; margin-top: 20px;">
                    <?php 
                    $img3 = BASE_URL."assets/templates/template2/cpd-logo.png";
                    ?> 
            ...
            <div class="barcode" style="margin-top: 40px;">
                    <?php 
                    $img4 = BASE_URL."assets/templates/template2/barcode.png";
                    ?> 
