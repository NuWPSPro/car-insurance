     ...
     <tr>
      ...
      <tr>
        <td align="center">
                ...
                <p
                    style="font-size: 23px;color: #2e85c1; margin-top: 13px; font-family: 'Montserrat', sans-serif; font-weight: 600;"><?php echo ucwords($certificate[0]['training_title']); ?></p>
                ...
                <table width="100%">
                    <tr>
                        <td style="text-align: left; padding: 0 0 0 9px;">
                            ...
                            <p
                                style=" color: #fff; font-size: 13px; margin: 9px 0; font-family: 'Montserrat', sans-serif; ">
                        ...
                        <td style="text-align: right;  padding-right: 10px;">
                            ...
                            <p
                                style="color: #fff; font-size: 14px; margin: 15px 0; font-family: 'Montserrat', sans-serif;">
                                Certificate Number</p>
                            <p
                                style="color: #f2cd1f;font-size: 13px; font-weight: 600; font-family: 'Montserrat', sans-serif; text-transform: uppercase; letter-spacing: 1.1px; margin: 0;"><?php echo $cust_data[0]['certificate_id'];?></p>
                        </td>
                    </tr>
                </table> 
