...
<div class="innerContent professional-advertise_list">
    <div class="container">
        <div class="row">
             <?php  $this->load->view('professional/sidebar');  ?> 
                ...
                <div class="row">
                <div class="col-md-12"> 
          <h3 class="border-title text-left">My ADS List</h3>
        ...
        <?php 
          foreach ($advertise as $key => $value) {
              $idd = $value['id'];
							...
							{  
                $day = ($value['duration'] * 7); // 1 is equal to 1 week or 7 days
								$end = date("Y-m-d",strtotime($value['purchased_on'].'+'.$day.'days')); 
								$inactivelist.='<tr>';
								$inactivelist.='<td>'.$value['title'].'</td>';
                ...
                $inactivelist.='<td>'.$value['package_end_date'].'</td>';
                        ...
                        <tr>
                          ...
                          <td><img src="<?php echo BASE_URL.'assets/upload/'.$value['package_image'];?>" style="width: 50px; width: 50px;"></td>
						              <td>$<?php echo $value['amount'];?></td>
                          <td>
                            <a href="javascript:void(0)" onclick="showEditform(<?php echo $idd; ?>)">Edit</a>
							              <a href="<?php echo BASE_URL.'provider/renew/'.$idd;?>">View Report</a>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
			  ...
			  <div class="col-md-12"> 
         <h3 class="border-title text-left">IN-Active ADS List</h3>
         <div class="table-responsive">
              <table class="table table-condensed">
                      <thead>
                        <tr>
