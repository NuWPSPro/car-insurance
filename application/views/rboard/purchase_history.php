			...
			<div class="col-sm-8">
				<div class="card">
					<div class="card-header">
        				<h3 class="border-title text-left">Purchase History</h3>
					</div>
								...
								<?php if(isset($purchase_history) && !empty($purchase_history)){ 
									...
									foreach($purchase_history as $value){
										echo '<tr>
												...
												<td><a href="javascript:void(0)" data-id="'.$value->id.'"  data-value="RBoard" class="btn btn-primary showBill" style="user-select: auto;">
												<i title="View Receipt" class="fa fa-file-text-o"></i></a>
												</td>
											</tr>';
									 } 
									 echo '</table>';
