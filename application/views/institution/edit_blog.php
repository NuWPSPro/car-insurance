	...
	<div class="container">
		...
		<div class="col-sm-9">
			...
			<h3 class="border-title text-left"> Edit Blog Page</h3> 
                 <form action="<?php echo BASE_URL.'institution/edit_blog/'.$blog[0]['id']; ?>" method="post" enctype="multipart/form-data" name="form100" id="form100">      
	                 ...
	                 <div class="form-group">
						...
						<input  name="country" id="country" class="form-control" size="20"  type="hidden" value="<?php echo $blog[0]['country']?>">
	                    <span class="error"><?php echo  form_error('country'); ?></span>
	                 </div>
																		
					<div class="form-group">
						<label>Title <span class="required"> * </span> </label>
						<input  name="title" id="title" class="form-control" size="20"  type="text" value="<?php echo $blog[0]['title']?>">
