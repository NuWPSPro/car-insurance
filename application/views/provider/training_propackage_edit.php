            ...
            <div class="col-sm-12">
                ...
                <div class="step-wise-query provider-overview">
                    ...
                    <div class="tab-content steps-detail">
                        ...
                        if($this->uri->segment('2')=="training_propackage_edit"){
                          $this->session->set_userdata('current_training_id', $this->uri->segment('3')); 
                        } 
                        ?>
               ...
               <!--  <p><h1>PRO PACKAGE $50.00</h1></p>
				...
				<form method="post" action="<?php echo site_url('provider/training_propackage_edit'); ?>" enctype="multipart/form-data" name="speakerform" id="speakerform">
                    ...
                    <section>
                        <div>
                            ...
                            <label for="control_01">
                                <img src="<?php echo BASE_URL();?>/assets/images/uploads/template1.jpg" alt="">
                            </label>
                        </div>
                        <div>
                            <input type="radio" id="control_02" name="select" value="2">
                            <label for="control_02">
                                <img src="<?php echo BASE_URL();?>/assets/images/uploads/template2.jpg" alt="">
                            </label>
                        </div>
                        <div>
                            <input type="radio" id="control_03" name="select" value="3">
                            <label for="control_03">
                                <img src="<?php echo BASE_URL();?>/assets/images/uploads/template3.jpg" alt="">
                            </label>
                        </div>
                    </section>
				...
				<button type="submit" class="btn btn-primary">Select Template</button>
                        ...
                        <div class="training-logo">
                            ...
                            <a class="pro-version" href="#">PRO-VERSION <span class="doler-pro"> $ 50.00</span></a>
                        ...
                        <div class="training-logo-box">
                                ...
                                <div class="training-logo-box">
                                    ...
                                    <span class="instant-content">Free 100 <br> Digital Certificates</span>
                                </div>
                                <div class="training-logo-box">
