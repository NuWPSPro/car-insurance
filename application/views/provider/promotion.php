<?php $this->load->view('template/picture_provider'); 
	  $under_ins = $this->session->userdata('logged_in')['under_insititution']; 
	...
	<div class="container">
		...
		<div class="step-wise-query provider-overview">
			<ul class="nav-tabs hidden-xs">
				...
				<?php if( $under_ins == 0 ){ ?>
	            <li class="active"><a href="<?php echo site_url('provider/promotion');?>">Promotion</a></li><?php } ?>
		...
		<div class="tab-content steps-detail">
			...
			<div id="step1" class="tab-pane fade in active">
				...
				<form action="<?php echo site_url('provider/promotion');?>" method="post" enctype="multipart/form-data" name="form1" id="form1"> 
				<div class="row">
					...
					<div class="col-sm-12 form-group">
						...
						<select class="form-control" name="promote" id="promote" onchange="showbutton()">
							...
							<option value="0_1">Regular Listing - Free, bottom section exposure.</option>
							<option value="10_2">Featured Listing - Paid, top section exposure.</option>
		...
		<div class="col-sm-12 form-group" id="featured" style="display: none;">
			<div class="payform" >
	            ...
	            <div class="form-control" style="background-color: green;">
	            	<a href="javascript:void(0)" onclick="paynow()" id="course_pricehtml">$<?php echo $dailprice; ?> Pay Now</a>
	            </div>
...
<form action="<?php echo PAYAPAL_URL; ?>" method="post" name="CoursePromotion" id="CoursePromotion">
    ...
    <input type="hidden" name="cancel_return" value="<?php echo site_url('provider/cancel_promotion'); ?>">
