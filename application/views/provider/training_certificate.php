...
<style>
    ...
    <form action="<?php echo site_url();?>/provider/choose_certificate" method="post" enctype="multipart/form-data" name="form1" >
        <div class="row">
        <?php echo $this->session->flashdata('response'); ?>               
            ...
            <div class="col-sm-2 form-group">
                    <input type="submit" name="next" class="btn btn-success btn-lg" value="Save & Next" name="fileSubmit">
            </div>
        </div>
    </form>
