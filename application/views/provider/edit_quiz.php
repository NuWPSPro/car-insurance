...
<?php   $this->load->view('provider/sidebar');
	...
	<div class="col-sm-9">
			...
			<div class="clearfix">
				<h3 class="border-title pull-left">Edit Quiz</h3>
			...
			<div class="step-wise-query">
				...
				<li class="active"><a  href="<?php echo site_url('provider/edit_quiz/').$cid;?>">Quiz</a></li>
		...
		<?php $qid =  $this->uri->segment(4); 
				$qurl = ($qid != '') ? $qid :'';
		?>
	<form action="<?php echo site_url('provider/edit_quiz/').$cid.'/'.$qurl; ?>" method="post" enctype="multipart/form-data" name="Quizedit" id="Quizedit">
		<?php echo $this->session->flashdata('response');?>
				...
				<?php if($qid != ''){
						...
						//foreach ($quiz as $key => $value) {  ?>
							...
							<div class="col-sm-12 form-group" >
								<label>Rationale</label>
								 <textarea class="form-control text_editor" name="urational"><?php echo $currentquize[0]['rational'];?></textarea>
                                        ...
                                        <div class="after-add-more count-q">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="answere1[]" required>
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="answere2[]" required>
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="answere3[]" required>
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="answere4[]" required>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select  class="form-control" name="correct_answere[]" required>
                    ...
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <?php
                        foreach ($quiz as $key => $value) { 
                        	if($value['correct_answere']==1){ $correct = $value['answere1']; }
                        	elseif($value['correct_answere']==2){ $correct = $value['answere2']; }
                        	elseif($value['correct_answere']==3){ $correct = $value['answere3']; }
                        	else{ $correct = $value['answere4']; }
                            ...
                            <tr>
                                ...
                                <td><?php echo ($value['rational']!='')?$value['rational']:'--'; ?></td>
                                <td>
                                    <a class="btn btn-default" title="Edit" href="<?php echo site_url('provider/edit_quiz/'.$cid.'/'.$value['id'].'');?>"><i class="fa fa-pencil"></i></a>
                                    <a class="btn btn-default" title="Delete" href="<?php echo site_url('provider/delete_quiz/'.$cid.'/'.$value['id'].'');?>" onclick="return confirm('Are you sure, you want to delete it?')"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
