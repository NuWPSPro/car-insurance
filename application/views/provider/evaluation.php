...
<div class="innerContent">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9">
                <h3 class="border-title text-left">Create Evaluation</h3>
                <div class="step-wise-query provider-overview">
                    <ul class="nav-tabs hidden-xs">
                        ...
                        <li class="active"><a href="<?php echo site_url('provider/evaluation');?>">Evaluation</a></li>
                        <?php 
        ...
        <div class="tab-content steps-detail">
            ...
            <div id="step1" class="tab-pane fade in active">
                ...
                <div class="row">
                    ...
                    <form action="<?php echo site_url('provider/evaluation');?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
