<?php  $this->load->view('car_company/picture'); ?>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Send to RT Status</th>
                    ...
                    <tbody>
                        ...
                        // echo '<pre>'; print_r($listing); echo '</pre>'; 
                            ...
                            @$i++;
                            if($list['type']=='1'): $type = '<span class="text-primary">Comprehensive</span>'; endif; 
                            if($list['type']=='2'): $type = '<span class="text-warning">Third Party</span>'; endif;

                            if($list['send_to_institution']==1): $status = '<span class="text-success">Yes</span>';
                            else: $status = '<span class="text-danger">No</span>'; endif; 
                            ?>
                        <tr>
                            <th scope="row"><?=$i;?></th>
                            <td><?=$list['name'];?></td>
                            ...
                            <td><?=$status;?></td>
                            <td>
                                <!-- <a href="<?=base_url('provider/edit_insurance/'.$list['insure_id']); ?>" class="btn btn-primary m-1" title="Edit"><i class="fa fa-edit"></i></a> -->
                                <!-- <a href="<?=base_url('provider/delete_insurance/'.$list['insure_id']); ?>" onclick="return deleteInsurance();" class="btn btn-danger m-1" title="Delete"><i class="fa fa-trash"></i></a> -->
                                <a href="javascript:void(0);" data-id="<?=$list['insur_id']; ?>" data-value="<?=$list['certificate_id']; ?>" class="btn btn-primary m-1 showRTInfo" title="Send to Road Traffic"><i class="fa fa-paper-plane" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; 
                        endif; ?>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(getdata){
                    ...
                    // console.log(obj);
                        ...
                        $.ajax({
                            url: 'https://ceonpoint.com/roadtraffic/admin/Api/add_insurance',
                            type: 'POST',
        ...
        $('.sendToRT').click(function(){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url('rboard/get_insurance');?>',
                ...
                success: function(result){
                    ...
                    console.log(json);
                    // $.ajax({
                    //     url: 'https://ceonpoint.com/roadtraffic/admin/Api/add_course',
                    //     type: 'POST',
                    //     data: json,
                    //     dataType: 'json',
                    //     success: function(result){
                    ...
                    // });
                            ...
                            alert('You have already sent that course to Roadt Traffic.');
                    }
                }
            }); 
        });
