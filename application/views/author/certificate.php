...
<div class="innerContent author-certificate">
	<div class="container">
		<div class="row">
            ...
            <div class="col-sm-9">
        		...
        		<div class="step-wise-query">
                     <ul class="nav-tabs hidden-xs">
                        ...
                        <li class="active"><a href="<?php echo site_url('author/certificate');?>">Certificate</a></li>
	...
	<div class="tab-content steps-detail">
        ...
        <div id="step1" class="tab-pane fade in active">
            ...
            <form action="<?php echo site_url('author/certificate');?>" method="post" enctype="multipart/form-data" name="form1" id="form1"> 
                <div class="row">
                ...
                <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control" name="certificatetitle" id="certificatetitle" placeholder="OF COMPLETION"  required>
                        <span class="error"><?php echo  form_error('certificatetitle'); ?></span>
                </div> 

                <div class="col-sm-12 form-group">
                        <label>Intro Text<sup>*</sup> : </label>
                        <input type="text" class="form-control" name="introText" id="introText" placeholder="has successfully completed the" required>
                ...
                <div class="row">
                    <div class="col-sm-12 form-group" id="signloop">
                        ...
                        <div class="form-group sertificat-choose">
                            <input type="text" class="form-control" name="name[]" placeholder="Name" multiple="multiple" required>
                                <!-- <span class="error"><?php echo  form_error('name'); ?></span> -->
                            <input type="text" class="form-control" name="position[]" placeholder="Position" value="" multiple="multiple" required>
