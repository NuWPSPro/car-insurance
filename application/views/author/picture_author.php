...
?>
    <div class="professionals-banner author-picture">
        <div class="container">
            <div class="row">
                    ...
                    <?php echo form_open(base_url('author/updateinfo'), array('class' => '', 'enctype' => 'multipart/form-data', 'id' => 'form_updateinformation', 'enctype' => 'multipart/form-data')); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="edu_elementary" value="<?php if(!empty($profuserdata['edu_elementary'])){echo $profuserdata['edu_elementary']; } ?>" class="form-control">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="edu_high_school" value="<?php if(!empty($profuserdata['edu_high_school'])){echo $profuserdata['edu_high_school']; } ?>" class="form-control">
                                <div class="row mt-3">
                                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                <label>college</label>
                                <input type="text" name="edu_college" value="<?php if(!empty($profuserdata['edu_college'])){echo $profuserdata['edu_college']; } ?>" class="form-control">
                                <div class="row mt-3">
                                    <div class="col-md-6">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="edu_masteral" value="<?php if(!empty($profuserdata['edu_masteral'])){echo $profuserdata['edu_masteral']; } ?>" class="form-control">
                                <div class="row mt-3">
                                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="edu_doctoral" value="<?php if(!empty($profuserdata['edu_doctoral'])){ echo $profuserdata['edu_doctoral']; } ?>" class="form-control">
                                <div class="row mt-3">
                                    <div class="col-md-6">
