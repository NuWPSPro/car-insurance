...
<div class="innerContent author-lesson">
    <div class="container">
        <div class="row">
            <?php 
        ...
        ?>
            <div class="col-sm-9">
                ...
                <div class="step-wise-query author-overview">
                    <ul class="nav-tabs hidden-xs">
                        <li><a href="<?php echo site_url('author/overview')?>">Overview</a></li>
                        <li class="active"><a href="<?php echo site_url('author/lesson')?>">Lessons</a></li>
                    ...
                    <div class="tab-content steps-detail">
                        <form action="<?php echo site_url('author/lesson');?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
                            <?php echo $this->session->flashdata('response');?>
                            <h3>Course Lesson
                                <button style="float:right" class="btn btn-success add-more" id="add" type="button"><i class="glyphicon glyphicon-plus"></i> Add Lesson</button>
                            </h3>
                            <div class="row">
                             ...
                             <!--    <div class="col-sm-12 form-group">
                                    ...
                                    <div class="lesson-copy bg-gray p-20 mb-10">
                                        <div class="form-group">
                                            <label>Lessons Title <sup>*</sup></label>
