...
<?php 
// echo"<pre>";print_r($certificate[0]); 
$this->load->view('template/picture_author'); ?>
<?php 
...
<div class="innerContent author-edit-certificate">
	<div class="container">
		<div class="row">
                ...
                <h2><?php echo $course[0]['course_title']; ?></h2>
			     <h3 class="border-title text-left">Edit Course</h3>
                    ...
                    <ul class="nav-tabs hidden-xs">
                        ...
                        <li class="active"><a  href="<?php echo site_url('author/edit_certificate/').$cid;?>">Certificate</a></li>
		  ...
		  <a class="title-mobile" data-toggle="tab" href="#step1">Overview</a>
		      <div id="step1" class="tab-pane fade in active">
			     ...
			     <h3>Edit Certificate</h3>
                    <form action="<?php echo site_url('author/edit_certificate/').$cid; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1"> 
            <div class="row">
                ...
                <input type="hidden" name ="id" value ="<?php echo $certificate[0]['id']; ?>">               
                    ...
                    <div class="col-sm-12 form-group">
                        <label>a) CATEGORY <sup>*</sup></label>
                            <select name="category" id="category" class="form-control changecategory" onchange="gettemplete()">
                        ...
                        <div class="item">
                            <label>  
                                <div class="sertificate-iner-box">
                                    <input type="radio" class="tt" name="templete_id" value="<?php echo $temp->id;?>" <?php if($certificate[0]['templete_id'] == $temp->id ){ echo 'CHECKED'; } ?> >
                    ...
                    <div class="after-add-more-one">
                        <div class="row">
                            ...
                            <div class="logocancel" style="display: flex; align-items: center;">
                                <a href="<?php echo site_url('author/deletelogo/'.$certificate[0]['id'].'/'.$userdetails->id.'/2'); ?>" class="cancel-mark" id="cancel" title="delete" onclick="return confirm('Are you sure? Do you want to delete it.')"><i class="fa fa-close"></i></a>
    ...
    <div class="table-responsive">
        <table  class="table table-striped table-bordered" style="width:100%">
            ...
            <?php foreach($templete as $temp){ 
                ...
                <tr>      
                    <td>
                     <!-- <?php echo $certificate[0]['category']; ?> -->
                        <img style="height: 80px; width:80px;" src="<?php echo ASSETS_URL.'upload/certificate_templete/';?><?php echo $temp->temppreview; ?>" alt="<?php echo $temp->template_no.' * '.$temp->category; ?>" > 
                   </td> 
                </tr>
            <?php } } ?>
            </tbody>
  ...
  <div class="modal fade" id="finalCertificate">
    <div class="modal-dialog modal-xl">
      <div class="modal-content" style ="width: 950px;">
      
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Preview of Your Certificate</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        
        <!-- Modal body -->
        <div class="modal-body" style="padding:0px 10px 10px 0px;">
  ...
  <a href="#" id="scroll" style="display: block;"><span></span></a>
    ...
    <script src="http://ceonpoint.com/assets/js/bootstrap-select.min.js"></script>
    <script src="http://ceonpoint.com/assets/js/countrypicker.js"></script>
    ...
    <script type="text/javascript" src="http://ceonpoint.com/assets/js/plugin.js"></script>
    <script src="https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js"></script>
    <script src="https://cdn.datatables.net/1.10.19/js/dataTables.bootstrap.min.js"></script>
    <!-- <script src="http://ceonpoint.com/assets/js/owlcarousel/owl.carousel.js"></script>
    <script src="http://ceonpoint.com/assets/js/owlcarousel/owl.js"></script>
    <script src="http://ceonpoint.com/assets/css/owl.carousel.css"></script> -->
    ...
    <script>
        function gettemplete(){
              ...
              $.ajax({
                            type: "POST",
                            url: '<?php echo base_url("author/get_certificate_temp");?>',
                            dataType: 'json',
    ...
    function preview_certificate(uid,cid){
         ...
         $.ajax({
                    type: "POST",
                    url: '<?php echo base_url("author/preview_course_certificate");?>',
