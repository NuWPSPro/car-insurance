...
<div class="innerContent author-income-report">
    <div class="container">
        <div class="row">
  ...
  $dataPoints2 = $array2;
	...
	foreach ($month1 as $key => $value) {
      ...
      <div class="circle-income text-center">
        <span>$<?php echo number_format(floatval($todayIncome),2);?></span>
      ...
      <div class="col-sm-3 form-group">
        <div class="circle-income text-center">
        <span>$<?php echo number_format(floatval($monthIncome),2);?></span>
      ...
      <div class="col-sm-3 form-group">
        <div class="circle-income text-center">
        <span>$<?php echo number_format(floatval($yearIncome),2);?></span>
    ...
    <div class="col-sm-3 form-group">
      ...
      ?>
      <div class="circle-income text-center">
        <span>$<?php echo number_format(floatval($totalIncomeProvider),2);?></span>
...
<div class="">
  ...
  <div class="col-sm-12">
		 <div class="panel-body detail-income-report">
            ...
            <p class="text-center">
                <a class="btn btn-primary" href="<?php echo BASE_URL.'author/income_report?month=&year='.date('Y'); ?>">
                    Course Sale Income
                </a>
            </p> 
        </div>
...
<div class="col-sm-2 form-group">
    <a href="<?php echo site_url('author/income_report?month=&year='.date('Y').'');?>">    
...
?>
<!--<div class="col-sm-4 form-group">
<p style="font-weight: bold;">Total Income : $<?php echo $ss;?></p>
</div>

<div class="col-sm-4 form-group">
<input style="margin-top: 34px;" type="button" class="btn btn-primary" value="Create Invoice" onclick="create_invoice()">
</div> -->
<?php 
}
?>
...
<?php 
$sum2 =0; 
// echo'<pre>';print_r($totalData[0]);
foreach ($totalData as $key => $value) {
  $sum2 = $sum2+$value['unitprice'];
}
?>           <div class="col-sm-12"> 
			<div class="panel panel-default">
                        <div class="panel-body detail-income-report">
            <center>
              ...
              <p>Total Income $<?php echo number_format($ss,2);?></p>
            </center>
			</div>
			</div>
			</div>
			<div class="col-sm-12">
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered">
            			...
            			$count = 1; 
						foreach ($totalData as $key => $value) {
				              $price = number_format(floatval($value['unitprice']),2);
				              $tax = floatval($value['ptax']);
				              $unitPrice = number_format($price - floatval($tax));
				              $netIncome = $unitPrice;
				              $adminIncome = floatval(($unitPrice*30)/100);
				              $cepIncome = floatval(($unitPrice*70)/100);
				              $adminNetIncome = $adminIncome;
							  $sum = $sum+$value['unitprice'];
...
<script type="text/javascript">
    function searchdata() {
        ...
        var base_url = "<?php echo base_url()."author/income_report?";?>";
