...
<?php 
		$uid = $this->session->userdata('logged_in')['id']; 
	  	...
	  	?>
<div class="innerContent author-promotion">
    <div class="container">
        <div class="row">
            <?php 
		...
		?>
            <div class="col-sm-9">
                ...
                <div class="step-wise-query provider-overview">
                    <ul class="nav-tabs hidden-xs">
                        ...
                        <?php if($uins == '0'){ ?>
                        <li class="active"><a href="<?php echo site_url('author/promotion'); ?>">Promotion</a></li>
                    	<?php } ?>
			...
			<div id="step1" class="tab-pane fade in active">
				...
				<form action="<?php echo site_url('author/promotion');?>" method="post" enctype="multipart/form-data" name="author-promostion" id="author-promostion"> 
				<div class="row">
...
<form action="<?php echo PAYAPAL_URL; ?>" method="post" name="frmPayPal1" id="frmPayPal1">
    ...
    <input type="hidden" name="item_number" id="item_number" value="<?php echo $this->session->userdata('current_course_id');?>">
    ...
    <input type="hidden" name="cancel_return" value="<?php echo site_url()?>/author/promotion">
