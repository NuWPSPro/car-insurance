...
<div class="innerContent author-edit-overview">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <ul class="nav-tabs hidden-xs">
                    <li class="active"><a  href="<?php echo site_url('author/course_edit/').$cid;?>">Overview</a></li>
        ...
        <div class="tab-content steps-detail">
            ...
            <div id="step1" class="tab-pane fade in active">
                ...
                <form action="<?php echo site_url('author/course_edit/').$cid;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
                    <div class="row">
                        <?php echo $this->session->flashdata('response');?>
                        <div class="col-sm-12 form-group">
                            <label>Course Title <sup>*</sup></label>
                            <input type="text" class="form-control" name="course_title" id="course_title" value="<?php echo $course[0]['course_title']; ?>">
                            <span class="error"><?php echo  form_error('course_title'); ?></span>
                        </div>
                        <div class="col-sm-12 form-group">
                            <label>Unit/s <sup>*</sup></label>
                            <select class="form-control" name="units" id="units" disabled>
                            <?php  for ($i=1; $i <=10 ; $i++) { ?>
                            <option <?php if($course[0]['units']==$i){ echo "selected";} ?> value="<?php echo $i;?>"><?php echo $i;?></option>
                            <?php  } ?>
                            </select>
                        ...
                        <?php if($uins == '0'){ ?>  
                         <div class="col-sm-6 form-group">
                            ...
                            <input type="number" class="form-control" name="price" id="price" value="<?php echo $course[0]['price']; ?>" placeholder="10.00">
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <input type="number" class="form-control" name="acceditation_no" id="acceditation_no" value="<?php echo $course[0]['course_acceditation_number']; ?>" placeholder="To be filled up by the CE Provider or Regulatory Board " disabled>
                            <span class="error"><?php echo  form_error('acceditation_no'); ?></span>
                        </div>

                        <div class="col-sm-12 form-group">
                            <label>Course Validity </label>
                            <input type="text" class="form-control" name="course_validity" id="course_validity" value="<?php echo $course[0]['course_validity']; ?>" placeholder="To be filled up by the CE Provider or Regulatory Board " disabled>
                            <span class="error"><?php echo  form_error('course_validity'); ?></span>
                        </div>

                    <div class="col-sm-12 form-group">
                        <label>Other Professions <sup>*</sup></label>
                    ...
                    <!-- <div class="col-sm-12 form-group">
                        <label>CE Provider <sup>*</sup></label>
                        <input type="text" readonly class="form-control" name="cpdprovider" id="cpdprovider" value="<?php echo $course[0]['cpdprovider']; ?>">
                    </div> -->

                   <!--  <div class="col-sm-12 form-group">
                        <label>Accreditation Number <sup>*</sup></label>
                        <input type="hidden" class="form-control" name="prc_acceditation_no" id="prc_acceditation_no" value="<?php echo $course[0]['prc_acceditation_number']; ?>">
                        <span class="error"><?php echo  form_error('prc_acceditation_no'); ?></span>
                    </div>

                   <div class="col-sm-12 form-group">
                        <label>Accreditation Validity <sup>*</sup></label>
                        <input type="hidden" class="form-control" name="acceditation_validity" id="acceditation_validity" value="<?php echo $course[0]['acceditation_validity']; ?>">
                        <span class="error"><?php echo  form_error('acceditation_validity'); ?></span>
                    </div> -->
