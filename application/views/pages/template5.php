...
<body class="index-2 index-3 index-4">
    ...
    <?php 
        if($training[0]['image']==''){
            $bannerimage = ASSETS_URL . 'images/uploads/'.$training[0]['image']; 
        }else{
            $bannerimage = ASSETS_URL . 'templates/images/hero-banner4.png'; 
        } ?>

    <section class="annual-nursespanel" id="myCarousel" style="background: url('<?php echo $bannerimage; ?>');">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="annual-textinfo">
                        ...
                        <h2><?php echo $training[0]['sub_title']; ?><strong><?php echo $training[0]['units']; ?>
                                Units</strong></h2>
                    </div>
    ...
    <section class="nurses-panel">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="nurses-imgbox"><img src="<?php echo ASSETS_URL.'templates/images/nurses-img3.png';?>" alt=""></div>
                </div>
            </div>
        </div>
    </section>

    <section class="speakingslider-panel" id="speaking">
        <div class="container">
            ...
            <?php   $sdata1 = $speaker;
                ...
                <div class="item">
                    <div class="speakings-box">
                        ...
                        <div class="speakings-namebox" id="<?php echo $bgcolor; ?>">
...
<!--     <section class="nurses-supportpanel">
    ...
    <section class="events-schedule" id="eventum-schedule" style="background-image: url('<?php echo ASSETS_URL.'templates/images/enent-bg4.png';?>');">
        <div class="container">
    ...
    <section class="evaluation evaluation-panel2" style="background-image: url('<?php echo ASSETS_URL.'templates/images/evelution-bg3.png';?>');">
        <div class="evaluation-content align-items-center">
            <h1>Evaluation</h1>
                    ...
                    <div class="footer-cmsbox">
                        <div class="footer-cmsinfo">
                            <div class="footer-cmsimg">
                                <a target="_blank" href="<?php echo site_url('pages/courses'); ?>"><img src="<?php echo ASSETS_URL . 'templates/images/online-courceiconwhite.png'; ?>" alt=""></a>
                            </div>
                            <p>Online Cource</p>
                        </div>
                        <div class="footer-cmsinfo">
                            <div class="footer-cmsimg">
                                 <a target="_blank" href="<?php echo site_url('pages/training'); ?>"><img src="<?php echo ASSETS_URL . 'templates/images/training-seminariconwhite.png'; ?>" alt=""></a>
                            </div>
                            <p>Training Seminar</p>
                        </div>
                        <div class="footer-cmsinfo">
                            <div class="footer-cmsimg">
                                <a href="javascript:void(0)" onclick="checklogin();"><img src="<?php echo ASSETS_URL . 'templates/images/upload-certificateiconwhite.png'; ?>" alt=""></a>
                            </div>
                            <p>Upload Certificate</p>
                        </div>
                        <div class="footer-cmsinfo">
                            <div class="footer-cmsimg">
                                <a target="_blank" href="<?php echo site_url('pages/Institutionspage'); ?>"><img src="<?php echo ASSETS_URL . 'templates/images/institution-webpageiconwhite.png'; ?>" alt=""></a>
                            </div>
