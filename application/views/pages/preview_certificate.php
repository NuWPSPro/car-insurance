...
if($cnumber !=""){ ?>
    <div class="innerContent">
        <div class="container">
            <div class="row">
                <div class="col-sm-7">
                    <iframe src="<?php echo ASSETS_URL.'upload/pdf/'.$cnumber; ?>.pdf" height="650" width="100%"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<div class="innerContent">
    ...
    <table style="  width:740px;    margin: 0 auto; background-image: url(<?php echo ASSETS_URL.('images/certificate_images/portrait-certificate.png');?>); background-repeat: no-repeat; background-size: cover;">
        <tr>
            <th>
            ...
            <td>
                <table style="width: 540px; margin: 0 auto; margin-top: 25px; margin-bottom: 90px;">
                    <tr>
                        <?php for($i=0;$i<$num;$i++){ ?>
                        <td
                            style="background-color: #fff;padding: 12px 12px;margin-right: 10px;width: 103px;text-align: center; border-right: 10px solid #fff;">
                ...
                width: 90%; margin: 0 auto; padding-top: 30px; padding-bottom: 38px; ">
                    <tr>
                        ...
                        <td style="text-align: right; width: 40%;">
                            <img src="<?php echo ASSETS_URL.('images/certificate_images/scan.png');?>" alt="barcode" style=" width: 70px">
                            <p
                                style="color: #fff; font-size: 17px; margin: 15px 0; font-family: 'Montserrat', sans-serif;">
                                Certificate Number</p>
                            <p
                                style="color: #f2cd1f;font-size: 19px; font-weight: 600; font-family: 'Montserrat', sans-serif; text-transform: uppercase; letter-spacing: 1.1px; margin: 0;">CERTI581902900</p>
                        </td>
                    </tr>
                </table>
            </td>
