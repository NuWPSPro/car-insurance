...
<html lang="en">
 ...
 <?php  $start_date = date($training[0]['start_date']);
    ...
    <header id="myCarousel" class="carousel slide">
        <div class="container">
            <div class="countdown-text-wrap py-5 text-left">
                <div class="countdown mt-5" id="countdown"></div>
...
<!--                        style="height: 250px; width: 350px; border-radius: 50%"-->
                ...
                <div class="col-md-8 text-left">
					...
					<div class="addon-content" style="height: 190px; overflow: auto;">
...
?>
    ...
    <div id="evaluatenow_details" class="modal fade" role="dialog">
                        ...
                        foreach ($training_speakers as $key => $value1) {
                            ...
                            <li onclick="speaker_name('<?php echo $value1['speaker_name']; ?>','<?php echo $value1['id']; ?>')" class="tra <?php if($key==1){ echo "active";} ?>">
                                <a data-toggle="tab" href="#menu<?php echo $key; ?>">
                                    ...
                                    <p style="width: 85px;text-align: center;"><?php echo $value1['speaker_name']; ?></p>
                                </a>
                            </li><?php } ?>
                        <?php } ?>
                            <!-- type=SYMPOSISM , SpeakerId = 0 -->
                            <li onclick="speaker_name('SYMPOSIUM',0)" class="tra">
 ...
 <div class="modal fade login_registration" id="login_registration" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg">
    ...
    <div id="videoModalPromo" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="videoModalPromo" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
