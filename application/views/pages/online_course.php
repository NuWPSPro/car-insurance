...
<div class="innerContent">
    <div class="container">
        <div class="row">
                ...
                <div class="panel panel-default btn-strip">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="<?php echo site_url('pages/courselist'); ?>" class="btn btn-primary">Online Ce courses</a>
                            </div>
                            <div class="col-md-6">
                                <a href="<?php echo site_url('pages/traininglist'); ?>" class="btn onlinecourse">Trainings/conventions</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-8">
                <h3 class="border-title text-left">Latest Courses</h3>
