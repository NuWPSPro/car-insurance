...
?>
        ...
        ?>
                ...
                <?php } ?>
                <h3 class="border-title text-left">Top List Training</h3>
                <?php 

if(empty($toplist)){

?>
                <div class="alert alert-info">Sorry no Top List records found!</div>
                <?php  
        ...
        ?>
                <div class="traning-seminar-wrap">
                    <div class="row course-item">
                        <div class="col-sm-4 course-image">
                            <a href="<?php echo site_url()?>/pages/training_details/<?php echo $value['id']?>"><img src="<?php echo ASSETS_URL; ?>images/uploads/<?php echo $value['image'];?>" alt=""></a>
                            <span class="badge-featured blue">Top List</span>
                        </div>
                        <div class="col-sm-8">
                            <div class="splms-event-details">
                                <h3><a href="<?php echo site_url()?>/pages/training_details/<?php echo $value['id']?>"><?php echo $value['title'];?></a></h3>
                ...
                <?php } ?>
                <h3 class="border-title text-left">Premium Training</h3>
                <?php 

if(empty($premium)){

?>
                <div class="alert alert-info">Sorry no premium records found!</div>
                <?php  
        ...
        ?>
                <div class="traning-seminar-wrap">
                    <div class="row course-item">
                        <div class="col-sm-4 course-image">
                            <a href="<?php echo site_url()?>/pages/training_details/<?php echo $value['id']?>"><img src="<?php echo ASSETS_URL; ?>images/uploads/<?php echo $value['image'];?>" alt=""></a>
                             <span class="badge-featured red">Premium</span>
                        </div>
                        <div class="col-sm-8">
                            <div class="splms-event-details">
                                <h3><a href="<?php echo site_url()?>/pages/training_details/<?php echo $value['id']?>"><?php echo $value['title'];?></a></h3>
