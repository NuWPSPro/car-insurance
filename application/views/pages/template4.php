...
<body class="index-2 index-3">
            ...
            <div class="row">
                <div class="col-md-12">
                   <?php if ($new_date == $end_date) {
                    ...
                    <div class="countdown-registerbox">
                        <div id="countdown">
                            <ul>
                                <li><span id="days">00 </span><p>days</p></li>
                                <li><span id="hours">00</span><p>Hour</p></li>
                                <li><span id="minutes">00</span><p>Minu</p></li>
                                <li><span id="seconds">00</span><p>Seco</p></li>
                            </ul>
                        </div>
    ...
    <section class="template_4_speaker" id="speaking">      
    <div class="container">     
        <div class="row">                     
            <div class="col-md-12">
                <div class="speakingslider-panel">
                    <h1>Who's Speaking?</h1>
                    <p>View our all speakers and learn from the expert.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="nurses-imgbox"><img src="<?php echo base_url('assets/images/uploads/').$training[0]['attach_logo']; ?>" alt=""></div>
                </div>
                <div class="col-md-8">
    ...
    <section class="event-sponsorspanel" id="event-sponsor">
        <div class="container">
            <div class="event-sponsorsbox">
                ...
                <?php foreach ($sponsors as $key => $value) { ?>
                    <a class="sponsors-logobox" target="_blank" href="<?php echo $value['urls']; ?>" title="<?php echo $value['sponsors_name']; ?>"><img src="<?php echo ASSETS_URL . 'images/uploads/' . $value['sponsors_image']; ?>" alt=""></a>
                <?php } ?>
            </div>
        </div>
    </section>
...
<!--     <section class="nurses-supportpanel">
        <div class="container">
            <ul>
                <li>
                    <p><strong>Anytime, Anywhere</strong> Lorem Ipsum is simply dummy text of the printing and
                        typesetting industry. Lorem Ipsum has been
                        the industry's standard dummy.</p>
                </li>
                <li>
                    <p><strong>24/7 Support</strong>Lorem Ipsum is simply dummy text of the printing and typesetting
                        industry. Lorem Ipsum has been
                        the industry's standard dummy.</p>
                </li>
                <li>
                    <p><strong>Anytime, Reservations</strong>Lorem Ipsum is simply dummy text of the printing and
                        typesetting industry. Lorem Ipsum has been
                        the industry's standard dummy.</p>
                </li>
            </ul>
    ...
    <section class="events-schedule" id="eventum-schedule" style="background-image: url('<?php echo ASSETS_URL .'templates/images/enent-bg2.png'; ?>');">
        <div class="container">
            ...
            <nav>
                <div class="general-ifo-tab">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-link gen-info <?php if ($_REQUEST['lesson']){  echo "";  }else{ echo "active"; } ?>" id="nav-general-tab" data-toggle="tab" href="#gen-nav-general" role="tab" aria-controls="nav-general" aria-selected="true">GENERAL INFORMATION
                        </a>
                        ...
                        <a class="nav-link gen-less <?php if ($_REQUEST['lesson'] == 1){  echo "active";  } ?>" id="nav-lesson-tab" data-toggle="tab" href="#gen-nav-lesson" role="tab" aria-controls="nav-lesson" aria-selected="false">LESSON</a>
                    </div>
                </div>
            </nav>
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade <?php if ($_REQUEST['lesson']){  echo "";  }else{ echo "show active"; } ?>" id="gen-nav-general" role="tabpanel" aria-labelledby="nav-general-tab">
                ...
                <div class="tab-pane fade <?php if ($_REQUEST['lesson'] == 1){  echo "show active";  } ?>" id="gen-nav-lesson" role="tabpanel" aria-labelledby="nav-lesson-tab">
                    <div class="gen-info-content">
...
<div class="modal fade login_registration" id="login_registration" class="modal fade" role="dialog" >
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
...
<div class="modal fade signupbypopup" id="signupByPopup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <a href="javascript:void(0);" style="color: blue;" onclick="termconditionpopups('professional')">Terms, Privacy Policy and Copyright policy </a>
    ...
    <div id="professionalsignup" class="modal fade" tabindex="-1" aria-labelledby="profModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="profModalLabel"><?=$professionals['title'];?></h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                    <div class="modal-body"> 
                        <div class="term"> 
    ...
    <script>
        ...
        setInterval(function() {
            ...
            countdown.innerHTML = '<ul><li><span id="days">' + days + '</span><p>Days</p></li><li><span id="hours">' + hours + '</span><p>Hours</p></li><li><span id="minutes">' + minutes + '</span><p>Minutes</p></li><li><span id="seconds">' + seconds + '</span><p>Seconds</p></li></ul>';
        }, 1000);
        ...
        function speaker_details(speaker_id) {
            ...
            $.ajax({
                ...
                var url = "<?php echo site_url('/pages/training_details/') . $tidd . '?lesson=1&&ppt=' ?>" + speaker_id;
        ...
        function termconditionpopups(role){
