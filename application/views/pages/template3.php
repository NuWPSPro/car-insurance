    ...
    <section class="annual-nursespanel" id="myCarousel" style="background: url('<?php echo ASSETS_URL . 'images/uploads/' . $training[0]['image']; ?>') no-repeat;background-size: cover;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12" id="speaking">
                        ...
                        <div class="speakingslider">
                            ...
                            foreach ($speaker as $key => $value) { 
                                if($key==0){ $bgColor =''; 
                                    ...
                                    if ($key % 2) {  $bgColor = 'bg-coler2'; } else {  $bgColor = 'bg-coler3'; }
                                     } ?>
                                <div class="item">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="new-temmap_iframe">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7443211.221913146!2d-80.46171889900646!3d24.368064137673187!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88d69a3bb2480f3d%3A0x133eb4836ac779e5!2sThe%20Bahamas!5e0!3m2!1sen!2sin!4v1600951899083!5m2!1sen!2sin"
...
<!--     <section class="nurses-supportpanel">
    ...
    <section class="general-info" id="gen-information">
        <div class="container">
            <div class="general-ifo-tab events-date-schedule">
                <ul id="tabs" class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a id="tab-A" href="#pane-D" class="nav-link gen-info active" data-toggle="tab"
                            role="tab">GENERAL INFORMATION</a>
                    </li>
                    <li class="nav-item">
                        <a id="tab-B" href="#pane-E" class="nav-link gen-over" data-toggle="tab" role="tab">TRAINING
                            OVERVIEW</a>
                    </li>
                    <li class="nav-item">
                        <a id="tab-C" href="#pane-F" class="nav-link gen-less" data-toggle="tab" role="tab">LESSON</a>
                    </li>
                </ul>
                <div class="tab-content" id="nav-tabContent">
                    <div id="pane-D" class="card tab-pane fade show active" role="tabpanel" aria-labelledby="tab-D">
                        <div class="card-header" role="tab" id="heading-D">
                            <h5 class="mb-0">
                                <!-- Note: `data-parent` removed from here -->
                                <a class="gen-info" data-toggle="collapse" href="#collapse-D" aria-expanded="true"
                        ...
                        <!-- Note: New place of `data-parent` -->
                        <div id="collapse-D" class="collapse show" data-parent="#content" role="tabpanel"
                    ...
                    <div id="pane-E" class="card tab-pane fade" role="tabpanel" aria-labelledby="tab-E">
                        <div class="card-header" role="tab" id="heading-E">
                            <h5 class="mb-0">
                                <a class="gen-over collapsed" data-toggle="collapse" href="#collapse-E"
                    ...
                    <div id="pane-F" class="card tab-pane fade" role="tabpanel" aria-labelledby="tab-F">
                        <div class="card-header" role="tab" id="heading-F">
                            <h5 class="mb-0">
                                <a class="gen-less collapsed" data-toggle="collapse" href="#collapse-F"
