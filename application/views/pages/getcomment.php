...
<p class="question"><b> Q. <?php echo $count; ?> <?php  echo $value['evaluation_question']; ?></b></p>
...
<?php $count++;
    ...
    $total_reponses = 0;
    for($i=5;$i>$n;$i--){
        $fivestarwhere = array('training_id'=>$tr_id,'speaker_id'=>$speakerID,'question_id'=>$value['id'],'star_mark'=>$i);
        $fivestar      = $this->user->get_record_by_field_name_all_record11('tbl_training_review',$fivestarwhere);

    //echo'<pre>';print_r($fivestar);
    // echo $this->db->last_query();
        ...
        // $total_reponses = $total_reponses + $total;
	...
	<!-- <section class="rating-box">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="rating-box-content rating-position">
                        <h3>Numbers</h3>
                        ...
                        <?php //$total_reponses = $FivetotalFiveStar1+$FivetotalFiveStar2+$FivetotalFiveStar3+$FivetotalFiveStar4+$FivetotalFiveStar5; ?>
                        <p><?=$total_reponses; ?></p>
                    </div>
                </div>
                
                <div class="col-md-6">
                    <div class="rating-box-content rating-participand">
                        <h3>Total Respondents:</h3>
                        <?php if($total == '' && $total_reponses == ''){
                            echo '0/0';
                        }else{ ?>
                        <ul>
                            <li>
                                <span><?=$total5;?>/<?=$total_reponses?></span>
                            </li>
                            <li>
                                <span><?=$total4;?>/<?=$total_reponses?></span>
                            </li>
                            <li>
                                <span><?=$total3;?>/<?=$total_reponses?></span>
                            </li>
                            <li>
                                <span><?=$total2;?>/<?=$total_reponses?></span>
                            </li>
                            <li>
                                <span><?=$total1;?>/<?=$total_reponses?></span>
                            </li>
                        </ul>
                        <?php } ?>
                    </div>
    ...
    $count1 = 1;
        foreach ($evaluation as $key => $values) { 
           if($values['question_type'] == 2){   ?>
            ...
            <?php 
                $count1++;
                $where   = array('training_id'=>$tr_id,'speaker_id'=>0,'question_id'=>$values['id']);
