                ...
                <table id="ins-list" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        foreach ($users as $key => $value) {  
                            ...
                            $rb_code = $this->db->get_where('tbl_rboard_details',array('user_id'=>$value['id']))->row_array()['rb_code'];
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Change RBoard's status</h4>
                </div>
                <div class="modal-body promatecompany">
                    <form action="<?php echo base_url('admin/changeRboardStatus'); ?>" method="post" enctype="multipart/form-data"
                        name="form1" id="form1">
                        <p>
