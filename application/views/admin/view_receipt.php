                      ...
                      <td>
                          <table style="width:100%">
                            <tr>
                                ...
                                <td style="text-align: right;font-size: 30px;font-weight: 600;text-transform: uppercase;color: red;">
                                    Official Receipt
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 50%;">
                                    <ul style="padding-left: 0px;list-style: none;">
                                        ...
                                        <li style="display: block; text-align: right;font-size: 15px;font-weight: 400;color: #4a4949;">
                                            <strong style="font-size: 14px;padding-right: 8px;color: #000;">Receipt #:</strong>
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td>
                                    <h2 style="font-size: 25px; font-weight: 500; margin-bottom: 15px;padding: 10px;background: #ed7d31;color: #fff; text-align: center; text-transform: uppercase;" >Payment Receipt</h2>
                                    <ul style="padding-left: 0px;list-style: none;">
